...
<div class="publications project-links">
    <a href="http://arxiv.org/abs/2504.05265" class="btn" role="button">arXiv</a>
    <a href="https://github.com/facebookresearch/motion_rolling_prediction" class="btn" role="button">Code</a>
    <a href="https://docs.google.com/forms/d/e/1FAIpQLSfT2dGSUk7MLZD8U0PoufEjR425WMtpBPiIMSwzLts2qK4L5A/viewform" class="btn" role="button">Dataset</a>
</div>
</header>
...
<div class="d-flex align-items-center justify-content-center" style="margin-top: 30px; margin-bottom: 20px">
    ...
    {% include video.liquid path="assets/video/rpm/converted_demo_video_dissemination.mp4" class="img-fluid rounded" controls=true  autoplay=true muted=true loop=true width="100%" %}
    </div>
</div>
